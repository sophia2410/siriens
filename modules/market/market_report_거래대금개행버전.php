...
<head>
    ...
    <style>
        ...
        .stock-row {
            ...
            align-items: center;
            width: 100%;
            margin-bottom: 5px; /* 종목명과 등락률 줄과 코멘트, 거래대금 줄 간의 간격 */
        }
        ...
        .stock-amount {
            ...
            margin-left: 10px;
            white-space: nowrap;
            align-self: flex-start; /* 거래대금을 코멘트와 같은 높이로 맞춤 */
        }
            ...
            <div class="group-card">
                ...
                <?php foreach ($stocks as $stock): ?>
                    ...
                    <div class="stock-item">
                        ...
                        <div class="stock-comment-row">
                            <span class="stock-comment"><?= htmlspecialchars($stock['stock_comment']) ?></span>
