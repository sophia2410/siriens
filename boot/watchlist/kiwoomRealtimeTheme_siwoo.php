...
<div style='border: 1px;' class="card-header py-3">
	...
	/ 거래대금 :
	<?php
		echo "<input type=text id=min_amount name=min_amount style='width:40px' value='30' onkeydown=\"if(event.keyCode==13) search()\"> 억 이상&nbsp;";
	?>
	/ 대표종목 :
	<?php
...
<table style="width:100%;">
	...
	<td>
		<div style="margin: 0; border: 0; font: inherit;vertical-align: baseline; padding: 0;height: calc(100vh - 100px);">
			<iframe id="iframeR" style="width: 100%; margin: 0; border: 0; font: inherit; vertical-align: baseline; padding: 0; height: calc(100vh - 100px);" src="kiwoomRealtimeTheme_B_siwoo.php">
			</iframe>
		</div>
	</td>
	</tr>
...
function search(sortBy='amount_last_min') {
	...
	iframeR.src = "kiwoomRealtimeTheme_B_siwoo.php?date="+date+"&minute="+minute+"&min_amount="+min_amount+"&detail_cnt="+detail_cnt+"&sortBy="+sortBy;
	return;
}
