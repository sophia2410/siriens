...
<?php
	if($0day_date == ''){
		...
		echo "<table border=1 class='table table-sm text-dark'>";
			...
			echo "<h4><b><a href='../siriens/stock_B.php?code=$code&name=$name' onclick='window.open(this.href, \'stock\', 'width=2500px,height=850,scrollbars=1,resizable=yes');return false;' target='_blank'>$name</a></b><h4>";
