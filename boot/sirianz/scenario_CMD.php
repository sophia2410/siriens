	...
	if($watchlist_date == ''){
		...
		echo "<table style='width:100%;'>
				...
				<td width=85%'>";
					...
					$query = "	SELECT STR_TO_DATE(B.date, '%Y%m%d') scenario_date_str
									...
									, buysell_category
								FROM calendar B
								LEFT OUTER JOIN sophia_scenario A
		...
		echo "	</td>
				...
				<div style='margin: 0; border: 0; font: inherit;vertical-align: baseline; padding: 0;width=20%; height: calc(100vh - 500px);'>
					<iframe id='iframe' style='width: 100%; margin: 0; border: 0; font: inherit; vertical-align: baseline; padding: 0; height: calc(100vh - 500px);' src='scenario_CMDT.php'>
					</iframe>
				</td>
			</tr>
		</table>";
