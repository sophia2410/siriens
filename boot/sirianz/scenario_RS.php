...
<?php
	if($trade_date == ''){
		...
		$mavg8 = "<font color=blue>".number_format($row['mavg8'])."</font>";
		...
		$buy_pick = "<input type=radio name=buy_pick value='Y' $checkY>매매대상<input type=radio name=buy_pick value='N' $checkN>트레킹대상 ";
		...
		echo "<td style='width:160px;'> 이슈/종목키워드 </td>";
		echo "<td style='width:25%'><input type=text name=issue value='$issue' style='width:30%;'><input type=text name=stock_keyword value='$stock_keyword' style='width:69%;'></td>";
		...
		echo "<td rowspan=2>이유</td>";
		echo "<td rowspan=2 colspan=6 style='width:70%;height:40px;'><textarea name='tracking_reason' style='width:99%; height:40px;'>$tracking_reason</textarea></td>";
		echo "<tr align=left>";
		echo "<td style='width:110px;'> 구분 </td>";
		echo "<td>$buy_pick</td>";
		echo "</tr>";
		echo "</tr>";
		echo "<tr align=left>";
		echo "<td> 이평가</td>";
		echo "<td colspan=8>[종가] $close_amt &nbsp; [3이평] $mavg3 &nbsp; [5이평] $mavg5 &nbsp; [8이평] $mavg8 &nbsp; [10이평] $mavg10 &nbsp; [15이평] $mavg15 &nbsp; [20이평] $mavg20 &nbsp; [60이평] $mavg60 &nbsp; [120이평] $mavg120 &nbsp; [224이평] $mavg224</td>";
		echo "</tr>";
		echo "<tr align=left>";
		...
		echo "<td> 복기 </td>";
		echo "<td colspan=6 style='height:40px;'><textarea name='buysell_review' style='width:99%; height:60px;'>$buysell_review</textarea></td>";
		echo "</tr>";
		echo "</table>";
