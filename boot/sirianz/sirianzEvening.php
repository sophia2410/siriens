...
<table style="width:100%;">
	...
	<td>
		<div style="margin: 0; border: 0; font: inherit;vertical-align: baseline; padding: 0;height: calc(100vh - 100px);">
			<iframe id="iframe" style="width: 100%; margin: 0; border: 0; font: inherit; vertical-align: baseline; padding: 0; height: calc(100vh - 100px);" src="sirianzEvening_B.php">
			</iframe>
		</div>
	</td>
	</tr>
...
function search() {
	...
	iframe.src = "sirianzEvening_B.php?report_date="+report_date;
	return;
}
...
function regi_theme() {
	...
	link = 'sirianzEvening_Theme.php?report_date='+report_date ;
