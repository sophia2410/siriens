...
<div>
	...
	<td style='width:89%' rowspan=2 valign=top>
		<div style="margin: 0; border: 0; font: inherit;vertical-align: baseline; padding: 0;height: calc(100vh - 100px);">
			<iframe id="iframe_L" style="width: 100%; margin: 0; border: 1; font: inherit; vertical-align: baseline; padding: 0; height: calc(100vh - 50px);" src="sirianzTradeL.php">
			</iframe>
		</div>
	</td>
	<td style='width:11%' rowspan=2 valign=top>
		<div style="margin: 0; border: 0; font: inherit;vertical-align: baseline; padding: 0;height: calc(100vh - 100px);">
			<iframe id="iframe_R" style="width: 100%; margin: 0; border: 1; font: inherit; vertical-align: baseline; padding: 0; height: calc(100vh - 50px);" src="sirianzTradeR.php">
			</iframe>
		</div>
	</td>
	</tr>
...
function getList(){
	...
	iframe_L.src = "sirianzTradeL.php?trade_date="+key_date+"&code="+key_val+"&brWidth="+brWidth;
	iframe_R.src = "sirianzTradeR.php?trade_date="+key_date+"&code="+key_val+"&brWidth="+brWidth;
	return;
}
...
function viewTrade(date, cd) {
	brWidth = window.innerWidth;
	iframe_L.src = "sirianzTradeL.php?trade_date="+date+"&code="+cd+"&brWidth="+brWidth;
	return;
}
</script>
