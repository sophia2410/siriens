...
if(isset($_POST['proc_fg'] )) {
	...
	// 크롤링 데이터 infostock_today_theme, infostock_theme_history, infostock_today_stock / sirianz_infostock_theme 테이블에 반영
	// sirianz_infostock_theme 테이블에 반영 로직을 infostock_Stock_script 로 이동. 일괄처리 되도록...
		...
		// // sirianz_evening_theme 반영
		// $qry = " REPLACE
		// 			INTO sirianz_infostock_theme(report_date, today_theme_cd, today_theme_nm, issue, detail, today_theme_rank, create_dtime)
