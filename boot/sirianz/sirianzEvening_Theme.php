...
<body id="page-top">
<form id="form" method=POST action="sirianzEvening_script.php" onsubmit="return false">
...
<table style="width:100%;">
	...
	<td>
		<div style="margin: 0; border: 0; font: inherit;vertical-align: baseline; padding: 0;height: 400px;">
			<iframe id="iframeT" style="width: 100%; margin: 0; border: 0; font: inherit; vertical-align: baseline; padding: 0; height: 100%;" src="sirianzEvening_Theme_T.php?report_date=<?=$report_date?>">
			</iframe>
		</div>
	</td>
	</tr>
	...
	<td>
		<div style="margin: 0; border: 0; font: inherit;vertical-align: baseline; padding: 0;height: calc(100vh - 500px);">
			<iframe id="iframeB" style="width: 100%; margin: 0; border: 0; font: inherit; vertical-align: baseline; padding: 0; height: 100%;" src="sirianzEvening_Theme_B.php">
			</iframe>
		</div>
	</td>
	</tr>
...
function search() {
	...
	iframeT.src = "sirianzEvening_Theme_T.php?report_date="+report_date;
	return;
}
...
function getStockList(theme, issue, keyword){
	report_date = document.forms[0].report_date.value;
	iframeB.src = "sirianzEvening_Theme_B.php?report_date="+report_date+"&theme="+theme+"&issue="+issue+"&keyword="+keyword;
	return;
}
...
?>
<iframe id="iframeH" name="iframeH" src = "sirianzEvening_script.php" width=100% height=100>
</html>
