...
if(isset($_POST['proc_fg'])) {
	...
	if($_POST['proc_fg'] == 'save') {
		$qry = "DELETE FROM sirianz_trade WHERE regi_id = '".$_POST['regi_id']."' AND trade_date='".$_POST['trade_date']."' AND code='".$_POST['code']."' ";
		echo $qry;
		$result = $mysqli->query($qry);

		$qry = "INSERT INTO sirianz_trade (trade_date, code, regi_id, daily_comment, good_comment, bad_comment, trade_rate, buysell_fg, create_dtime) 
